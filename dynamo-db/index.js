        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 13: return [4 /*yield*/, this.batchGetItem(payload)];
                    case 14: return [2 /*return*/, _b.sent()];
                    case 15: throw new Error("Operation  " + payload.operation + " not implemented");
                    case 16: throw new Error("Unknown operation name: " + payload.operation);
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        params = {
                            ...
                            ExpressionAttributeNames: utils_1.nullIfEmpty(__assign(__assign({}, (condition.expressionNames || {})), (update.expressionNames || {}))),
                            ExpressionAttributeValues: utils_1.nullIfEmpty(__assign(__assign({}, (condition.expressionValues || {})), (update.expressionValues || {}))),
                        };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.client
                            .batchGetItem({
                            RequestItems: utils_1.mapTableObject(payload.tables, function (request) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                data: utils_1.mapTableObject(Responses, function (items) { return items.map(function (item) { return utils_1.unmarshall(item); }); }),
                                unprocessedKeys: utils_1.mapTableObject(UnprocessedKeys || {}, function (request) { return request.Keys.map(function (key) { return utils_1.unmarshall(key); }); }),
                            }];
                }
            });
        });
