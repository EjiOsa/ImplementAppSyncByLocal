...
exports.mapTableObject = exports.unmarshall = exports.nullIfEmpty = void 0;
...
function mapTableObject(tableObject, mapper) {
    return Object.fromEntries(Object.entries(tableObject).map(function (_a) {
        var tableName = _a[0], value = _a[1];
        return [tableName, mapper(value)];
    }));
}
exports.mapTableObject = mapTableObject;
